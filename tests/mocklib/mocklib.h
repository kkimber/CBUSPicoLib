...
public:
    ...
    virtual void gpio_set_pulls(uint, bool, bool) = 0;
    virtual void gpio_set_slew_rate(uint, enum gpio_slew_rate) = 0;
    virtual void gpio_put(uint, bool) = 0;
    virtual void gpio_set_function(uint, gpio_function_t) = 0;

    // i2c functions
    virtual uint i2c_init(i2c_inst_t*, uint) = 0;
    virtual int i2c_write_blocking(i2c_inst_t *, uint8_t, const uint8_t *, size_t, bool) = 0;
    virtual int i2c_read_blocking(i2c_inst_t *, uint8_t, uint8_t *, size_t, bool) = 0;
    virtual int i2c_read_blocking_until(i2c_inst_t *, uint8_t, uint8_t *, size_t, bool, absolute_time_t) = 0;
...
public:
    ...
    MOCK_METHOD(void, gpio_set_pulls, (uint, bool, bool), (override));
    MOCK_METHOD(void, gpio_set_slew_rate, (uint, enum gpio_slew_rate), (override));
    MOCK_METHOD(void, gpio_put, (uint, bool), (override));
    MOCK_METHOD(void, gpio_set_function, (uint, gpio_function_t), (override));

    MOCK_METHOD(uint, i2c_init, (i2c_inst_t*, uint), (override));
    MOCK_METHOD(int, i2c_write_blocking, (i2c_inst_t *, uint8_t, const uint8_t *, size_t , bool ), (override));
    MOCK_METHOD(int, i2c_read_blocking, (i2c_inst_t *, uint8_t, uint8_t *, size_t, bool), (override));
    MOCK_METHOD(int, i2c_read_blocking_until, (i2c_inst_t *, uint8_t, uint8_t *, size_t, bool, absolute_time_t ), (override));
